...
| ADR-002 | Decided | Month-1 channel scope | Operate with one primary messaging channel for month 1. | Clay | 2026-02-22 | 2026-02-22 | Revisit only after month-1 KPI review. | `docs/project-objectives.md` |
...
| ADR-007 | Deferred | Multi-channel expansion | When should Honeybucket support additional channels beyond the primary channel? | Clay | 2026-02-22 | 2026-03-22 | Reassess after month-1 retrospective and KPI review. | `docs/project-objectives.md` |
